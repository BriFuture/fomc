...
from gdet.utils.np_utils import is_seq_of
from gdet.ops import box_iou_rotated
from .transforms import (TF_Mosaic, TF_RandomCrop, TF_RandomFlip, TF_Resize)

from gdet.core.bbox import norm_angle, obb2poly_np, poly2obb_np
from gdet.registries import PIPELINES as ROTATED_PIPELINES


@ROTATED_PIPELINES.register_module()
class TF_RResize(TF_Resize):
...
@ROTATED_PIPELINES.register_module()
class TF_RRandomFlip(TF_RandomFlip):
    """
...
@ROTATED_PIPELINES.register_module()
class TF_PesudoRRandomFlip(TF_RandomFlip):
...
@ROTATED_PIPELINES.register_module()
class TF_PolyRandomRotate(object):
    """Rotate img & bbox.
    ...
    def __init__(self,
        ...
        if mode == 'range':
            ...
            assert is_seq_of(angles_range, int) and len(angles_range), \
...
@ROTATED_PIPELINES.register_module()
class TF_RRandomCrop(TF_RandomCrop):
    ...
    def __init__(self,
        ...
        super().__init__(crop_size, crop_type,
                                          allow_negative_crop)
