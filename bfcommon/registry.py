...
class Registry:
    ...
    def __init__(self, name):
        self._name = name
        global _registry_modules
        if name not in _registry_modules:
            _registry_modules[name] = self
        else:
            raise ValueError(f"Dumplicated Registry: {name}")
