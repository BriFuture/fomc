...
from gdet.registries import MODEL_OPS
from gdet.ops import riroi_align_rotated
from bfcommon.fp16_utils import convert_fp32
from mmrotate.utils.misc import to_2tuple
from mmdet.models.roi_heads.roi_extractors.base_roi_extractor import BaseRoIExtractor
 
from gdet.registries import MODEL_HEADS as ROTATED_ROI_EXTRACTORS
...
class RotatedSingleRoIExtractor(BaseRoIExtractor):
    ...
    def build_roi_layers(self, layer_cfg, featmap_strides):
        ...
        layer_cls = MODEL_OPS.get(layer_type)
        assert layer_cls is not None, layer_type
    ...
    def forward(self, feats, rois, roi_scale_factor=None):
        ...
        """
        feats = convert_fp32(feats)
        if isinstance(self.roi_layers[0], riroi_align_rotated.RiRoIAlignRotated) :
        ...
        if torch.is_autocast_enabled():
            roi_feats = roi_feats.to(torch.float16)
        return roi_feats
